    ...
    <section className="mt-6 rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="mb-3 flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div>
          ...
          <h2 className="text-lg font-black text-slate-950">Participantes virtuales</h2>

          <p className="text-sm text-slate-600">Gestiona envio por WhatsApp, edicion, eliminacion y reset de enlaces.</p>
